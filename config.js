const config = {
  property: {
    ...
    neighborhoodDescription: "Exclusive Kleinburg Area home surrounded by Luxury homes, schools, parks, and nature.",
    onMarketComparables: [
  ...
  openHouse: {
    ...
    bundleItems: [
      ...
      { icon: "fas fa-star", text: "Completely finished Luxurious turn-key home including Finished Basement with kitchen and 2 extra bedrooms and Full Landscaping with pool and cabana with outdoor bathroom" },
      { icon: "fas fa-check-circle", text: "New high-end finishes including Full Kitchen, Herringbone flooring, Appliances (SubZero 72\"  Side-by-side Fridge/Freezer, Wolf 48 Stove, Bosh DW), Quartz countertop, 2 new furnaces and Air Conditioner, and Full Interlock driveway" },
  ...
  deploymentInfo: {
    repoName: "Open-House-999",
    repoUrl: "https://github.com/arslvn93/Open-House-999",
    tag: "Open House 11 Glen Abbey Tr",
    netlifyUrl: "http://Open-House-999.netlify.app/",
    netlifyId: "979592119"
  }
};